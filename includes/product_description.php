<section class="bg-black text-white py-20 relative overflow-hidden border-b border-slate-900">
  
  <!-- Red Glow Radial Gradient Effect -->
  <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-red-700/20 rounded-full blur-[140px] pointer-events-none"></div>
    ...
    <div class="grid md:grid-cols-12 gap-12 items-center">
      ...
      <div class="md:col-span-5 flex justify-center">
        <div class="relative w-full max-w-sm">
          <img src="/bottle_artwork.png" alt="Horse Fire Gold Cap Bottle Artwork" class="w-full h-auto object-contain max-h-[440px] drop-shadow-[0_20px_35px_rgba(204,0,0,0.35)] hover:scale-105 transition-transform duration-500">
        </div>
      </div>

      <!-- Right Column: Clean Text Content -->
      <div class="md:col-span-7 space-y-6 text-center md:text-left">
        <h2 class="font-serif text-3xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight">
          Product Description
        </h2>
        ...
        <div class="pt-2 flex flex-wrap items-center justify-center md:justify-start gap-4 text-xs font-semibold text-amber-400">
          <span class="flex items-center gap-1.5 bg-white/5 border border-white/10 px-4 py-2 rounded-full">
